...
//		String corrId10 = UUID.randomUUID().toString();
		...
		Producer producer1 = new Producer(collector, "You know you’re in love when you can’t fall asleep because reality is finally better than your dreams", 50, corrId1);
		Consumer consumer1 = new Consumer(collector, 100, corrId1);
		Producer producer2 = new Producer(collector, "I’m selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you can’t handle me at my worst, then you sure as hell don’t deserve me at my best.", 50, corrId2);
		Consumer consumer2 = new Consumer(collector, 100, corrId2);
		Producer producer3 = new Producer(collector, "The first step toward success is taken when you refuse to be a captive of the environment in which you first find yourself.", 50, corrId3);
		Consumer consumer3 = new Consumer(collector, 100, corrId3);
		Producer producer4 = new Producer(collector, "When one door of happiness closes, another opens; but often we look so long at the closed door that we do not see the one which has been opened for us.", 50, corrId4);
		Consumer consumer4 = new Consumer(collector, 100, corrId4);
//		
